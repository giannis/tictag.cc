  ...
  $(".button").click(function() {
	...
	var email = $("input#email").val();
		if (email == "" || email == "your e-mail goes here..") {
			$("label#emailError").fadeIn('slow');
	        $("input#email").focus();
    	    return false;
    	}
		else if (!emailReg.test(email)) {
			$("label#emailWrong").fadeIn('slow');
	        $("input#email").focus();
    	    return false;
		}
	var message = $("textarea#message").val();
		if (message == "") {
			$("label#messageError").fadeIn('slow');
...
$(document).ready(function() {
	...
	$("input#name").keypress(function (e){
		$("label#nameError").fadeOut('slow');	
	});
	$("input#email").keypress(function (e) {
		$("label#emailError").fadeOut('slow');						  
		$("label#emailWrong").fadeOut('slow');						  
	});
	$("textarea#message").keypress(function (e) {
		$("label#messageError").fadeOut('slow');						  
	});		
});